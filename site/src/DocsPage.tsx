...
export default function DocsPage({ docId }: DocsPageProps) {
  ...
  usePageMeta(
    activeDoc
      ...
      : { title: "项目文档", description: "Github Proxy 公开文档：安装部署、URL 格式、Git 加速、私有仓库、配置参考和系统设计文档。", canonicalPath: "/docs" },
  );
    ...
    <section className="docs-shell">
      <aside className="docs-sidebar" aria-label="文档目录">
        ...
        <div className="docs-sidebar-heading">
          ...
          <h1>项目文档</h1>
          <p>从安装部署、使用指南到系统设计，按分类查找需要的说明。</p>
        </div>
        <DocsSearch />
        <nav>
