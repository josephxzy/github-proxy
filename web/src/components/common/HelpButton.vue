<template>
  ...
  >
    ...
    <div
      v-else
      class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl ring-1 ring-gray-200 dark:ring-gray-700 w-[calc(100vw-32px)] sm:w-80 max-h-[80vh] sm:max-h-[70vh] overflow-hidden fixed sm:relative animate-scale-in"
    ...
    >
      ...
      <div class="flex items-center justify-between p-3 sm:p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/80 dark:bg-gray-900">
        ...
        <button
          @click="togglePanel"
          class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors p-1.5 -m-1"
        >
      ...
      <div class="p-3 sm:p-4 overflow-y-auto max-h-[calc(80vh-52px)] sm:max-h-[calc(70vh-60px)] space-y-3 sm:space-y-4 text-xs sm:text-sm">
        ...
        <div class="space-y-2">
          ...
          <div class="bg-gray-50 dark:bg-gray-900 ring-1 ring-gray-200/70 dark:ring-gray-700 rounded-lg p-3 font-mono text-xs text-gray-700 dark:text-gray-300">
            facebook<br>
            react vue<br>
            python web scraping
          </div>
        ...
        <div class="space-y-2">
          ...
          <div class="space-y-2">
            <div class="bg-gray-50 dark:bg-gray-900 ring-1 ring-gray-200/70 dark:ring-gray-700 rounded-lg p-3">
